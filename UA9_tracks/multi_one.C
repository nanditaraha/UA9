...
void multi_one()
{
  ...
  TH1I *hmulti_x = new TH1I("hmulti_x", "Simulataneous hit multiplicity for 2X and 3X planes",3, 0,3);
  TH1I *hmulti_y = new TH1I("hmulti_y", "Simulataneous hit multiplicity for 2Y and 3Y planes", 3, 0,3);

  TH1I *hmulti_all = new TH1I("hmulti_all", "Simulataneous hit multiplicity for all 2X, 3X, 2Y and 3Y planes", 3, 0,3);
  ...
  for (Int_t i = 1; i < nentries; i++) {
    ...
    */
    ...
    if(multi2x==1 && multi3x==1 && multi2y==1 && multi3y==1)
      hmulti_all->Fill(1);
    if(multi2x==2 && multi3x==2 && multi2y==2 && multi3y==2)
      hmulti_all->Fill(2); 
    else  hmulti_all->Fill(0);
